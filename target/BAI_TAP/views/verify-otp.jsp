...
<c:set var="pageTitle" value="Xác thực OTP" scope="request"/>
<jsp:include page="/common/web/header.jsp"/>
<div class="auth-wrapper">
    <div class="auth-card">
        <h2>Xác Thực Tài Khoản (OTP)</h2>
        <p style="color: #6b7280; font-size: 0.9rem; margin-top: -10px; margin-bottom: 20px;">
            Vui lòng nhập mã OTP 6 chữ số đã được gửi đến email của bạn để kích hoạt tài khoản.
        </p>
        ...
        <form action="${pageContext.request.contextPath}/verify-otp" method="post" class="auth-form">
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<c:out value='${username}'/>" placeholder="Tài khoản hoặc email" class="form-control" required>
            </div>
            <div class="form-group">
